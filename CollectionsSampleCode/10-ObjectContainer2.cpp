/** 10-ObjectContainer2.cpp
 *	
 *  In this version, we handle initialization differently.
 *
 *	@author		Thom MacDonald
 *	@version	2018.02
 *	@since		Jul 2018
 *	@see		Bronson, G. (2012). A First Book of C++ (4th ed.). Boston, MA: Course Technology.
 *	@see		CPRG4202.Lab05.Collections.pdf
*/
...
class PlayingCards
{
	...
	public:
		...
		void Initialize(int size); 	// Can be called on construction or any time after
