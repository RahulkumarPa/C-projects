/** CartesianPoint.StaticDataMember.cpp
 *	
 *	In this example program, did the following:
 *		- Declared and defined a static data-member.
 *   
 *	@author		<YOUR-NAME>
...
class CartesianPoint
{
  ...
  // TO_DO: Add a static data-member called sharedLimit (int):		
...
*/
// TO_DO: Initialize sharedLimit to the maximum value an int can hold (INT_MAX)
