...
int main()
{
	...
	try
	{
		...
		// if the card obj is face-down
		if(!cardObj.IsFaceUp) // demo isFaceUp field
		{
		   // flip it
		   cardObj.FlipCard(); // demo flipCard method
        }
		
		// flip the Black Jack no matter what.
		blackJack.FlipCard(); // demo flipCard method
		
		// Display the playing cards after flipping
		cout << "\n\nAfter Flipping" << endl
			 << "============================" << endl
			 << "cardObj is   : " << cardObj.ToString() << endl
			 << "blackJack is : " << blackJack.ToString() << endl << endl;
		...
		// Modify the two objects
		cardObj.SetRank("Queen"); 	// set cardObj rank to 12 (Queen)
		blackJack.SetSuit("Clubs"); 	// set blackJack suit to 3 (Clubs)
		
		// Display playing cards info after sets
		cout << "\n\nAfter Setting" << endl
			 << "============================" << endl
			 << "cardObj rank is now   : " << cardObj.GetRank() << endl
			 << "blackJack suit is now : " << blackJack.GetSuit() << endl << endl;
		
		// pause the output
		Pause();
		
		// Causing an exception
		cout << "\n\nCausing an Exception" << endl
			 << "============================" << endl
			 << "Setting cardObj rank to \"chicken\"" << endl << endl;
		
		cardObj.SetRank("chicken");
